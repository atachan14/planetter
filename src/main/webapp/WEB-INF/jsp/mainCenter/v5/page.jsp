...
<div style="display: flex; flex-direction: column; height: 450px;">
	...
	<div style="flex: 1; text-align: right; font-size: 16px; color: dimgray; align-items: flex-end;">
		<span style="color: royalblue; margin-right: 50px;">${mainCenter.data.name}</span>${mainCenter.data.criater}${mainCenter.data.date}</div>
</div>