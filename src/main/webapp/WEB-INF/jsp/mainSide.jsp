...
<div style="height: 100%; position: relative;">
	...
	<div style="position: absolute; bottom: 10%; width: 100%; text-align: center;">
		<form action="mainSide" method="post">
			<input type="submit" name="button" value="星屑を重ねる" class="side-button" style="margin-top: 20%"><br> <input type="submit" name="button" value="表紙を付ける" class="side-button" style="margin-top: 10%"><br>
		</form>
	</div>
</div>