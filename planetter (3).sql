...
('かほ', 'かほ', 10000, 'BeginersPlanet', 7, 2, 0, 99, '2024-12-15 23:05:23', 0, 0, 0, 0, 1, 0, 0),
('しまかほ', 'しまかほ', 10000, 'BeginersPlanet', 5, 6, 2, 100, '2024-12-15 23:06:19', 0, 0, 0, 0, 0, 0, 0),
('ちさ', 'ちさ', 9998, 'BeginersPlanet', 5, 5, 1, 79, '2024-12-15 22:12:41', 0, 2, 0, 0, 21, 0, 0),
('ちょこぱん', 'ちょこぱん', 9001, 'BeginersPlanet', 9, 7, 1, 99, '2024-12-15 23:09:34', 0, 1, 0, 0, 1, 0, 1),
('でかい犬', 'でかい犬', 10000, 'BeginersPlanet', 1, 1, 0, 100, '2024-12-16 04:24:56', 0, 0, 0, 0, 0, 0, 0),
('はみがき', 'はみがき', 113660, 'BeginersPlanet', 2, 6, 3, 999, '2024-12-15 18:16:34', 3, 2, 1, 0, 17, 0, 0),
('へろいも', 'へろいも', 152973, 'BeginersPlanet', 2, 2, 1, 1445, '2024-12-16 04:29:22', 1, 0, 0, 0, 4, 0, 0),
('まほ', 'まほ', 162773, 'BeginersPlanet', 4, 5, 3, 1767, '2024-12-15 18:20:20', 6, 1, 1, 0, 35, 0, 0),
('よしの', 'よしの', 10000, 'BeginersPlanet', 4, 2, 1, 100, '2024-12-16 03:15:33', 0, 0, 0, 0, 0, 0, 0),
('るる', 'るる', 10002, 'BeginersPlanet', 9, 7, 3, 100, '2024-12-16 01:57:20', 0, 0, 0, 0, 0, 0, 1),
('れ', 'れ', 10000, 'BeginersPlanet', 5, 1, 3, 100, '2024-12-14 08:07:09', 0, 0, 0, 0, 0, 0, 0),
('佐々木', '佐々木', 23898, 'だけ', 2, 1, 0, 1274, '2024-12-12 17:29:57', 2, 1, 0, 0, 27, 0, 0),
('原口', '原口', 8798, 'はあやい', 0, 2, 2, 90, '2024-12-15 23:28:13', 0, 2, 0, 0, 10, 0, 0),
('右利き', '右利き', 10000, 'BeginersPlanet', 5, 3, 1, 100, '2024-12-16 03:17:53', 0, 0, 0, 0, 0, 0, 0),
('味がしない', '味がしない', 4000, '味がしない星', 1, 0, 3, 66, '2024-12-15 13:49:18', 0, 0, 0, 0, 0, 1, 0),
('山本', '山本', 99997, 'BeginersPlanet', 8, 3, 3, 902, '2024-12-15 22:05:00', 5, 0, 0, 0, 51, 0, 0),
...
('雨', '雨', 10000, 'BeginersPlanet', 2, 5, 2, 100, '2024-12-16 04:26:34', 0, 0, 0, 0, 0, 0, 0);
...
CREATE TABLE `planet` (
  ...
  `backGroundColor` varchar(16) DEFAULT ' black'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `planet` (`name`, `xsize`, `ysize`, `criater`, `x`, `y`, `date`, `nameDisplay`, `stealth`, `backGroundColor`) VALUES
('', 3, 3, 'みけ', -4, 2, '2024-12-15 12:14:59', 0, 0, 'black'),
('beginerplanet', 20, 20, 'master', 9, 9, '2024-12-11 22:23:49', 0, 0, 'black'),
('BeginersPlanet', 10, 10, 'master', 0, 0, '2024-12-11 21:09:40', 0, 0, 'black'),
('hebe', 3, 3, 'りり', -14, 0, '2024-12-15 16:46:49', 0, 0, 'black'),
('ie', 3, 3, 'りり', -15, 5, '2024-12-15 16:46:27', 0, 0, 'black'),
('osasimi', 3, 3, '梅田', -8, -3, '2024-12-15 15:10:28', 0, 0, 'black'),
('osiruko', 3, 3, 'りり', -19, -1, '2024-12-15 16:47:20', 0, 0, 'black'),
('Test', 4, 4, 'Master', 2, -2, '2024-12-11 21:09:40', 0, 0, 'black'),
('tikyuu', 3, 3, 'りり', -10, 5, '2024-12-15 16:46:10', 0, 0, 'black'),
('waru', 3, 3, 'りり', -24, -2, '2024-12-15 16:47:46', 0, 0, 'black'),
('きりん', 3, 3, 'ゆうか', -13, -2, '2024-12-15 18:28:23', 0, 0, 'black'),
('さかな！', 3, 3, 'みけ', -4, 1, '2024-12-15 12:25:26', 0, 0, 'black'),
('さかな！さかな！', 3, 3, 'みけ', 2, 3, '2024-12-15 12:29:51', 0, 0, 'black'),
('じょ', 3, 3, '夜', 1, -1, '2024-12-15 12:31:31', 0, 0, 'black'),
('だけ', 3, 3, 'おっきいねこ', 0, -2, '2024-12-15 13:40:48', 0, 0, 'black'),
('てけどｎ', 4, 2, '梅田', -3, -5, '2024-12-15 15:08:39', 0, 0, 'black'),
('なかよし', 3, 3, 'はーちゃん', 1, 3, '2024-12-15 17:59:29', 0, 0, 'black'),
('はあやい', 3, 3, '爆速', -5, -5, '2024-12-15 12:33:13', 0, 0, 'black'),
('ひ', 2, 2, 'あかね', -2, 4, '2024-12-15 13:24:45', 0, 0, 'black'),
('ぽに', 1, 1, '爆速', -10, -6, '2024-12-15 12:34:11', 0, 0, 'black'),
('まるた', 3, 3, 'りり', -5, 0, '2024-12-15 16:45:44', 0, 0, 'black'),
('ものの', 3, 3, 'もの', -2, -2, '2024-12-15 12:30:15', 0, 0, 'black'),
('ゼッケン', 3, 3, '西沢', -15, -5, '2024-12-15 13:48:49', 0, 0, 'black'),
('味がしない星', 5, 1, '味がしない', 5, 0, '2024-12-15 13:49:49', 0, 0, 'black');
...
--
-- テーブルのデータのダンプ `pl_upgrade`
--

INSERT INTO `pl_upgrade` (`id`, `ugName`, `plName`, `sd`, `destiny`) VALUES
(14, '名前を変更', 'BeginersPlanet', 4000, 0),
(15, 'ホームを作成', 'BeginersPlanet', 40000, 2),
(16, '野犬を放流(3匹)', 'BeginersPlanet', 8000, 5),
(17, 'ミサイル発射', 'BeginersPlanet', 55000, 4),
(18, 'お引越し', 'BeginersPlanet', 20000, 1);
...
(71, 'tweet', 'BeginersPlanet', 7, 8),
(72, 'tweet', 'BeginersPlanet', 9, 3),
(74, 'tweet', 'はあやい', 0, 1),
(75, 'tweet', 'だけ', 2, 1);
...
(140, '夢だよ', 'ちな', '2024-12-15 22:12:22', NULL, 71),
(141, 'はい', 'ちさ', '2024-12-15 22:12:53', 5, NULL),
(142, 'みて。', 'ちさ', '2024-12-15 22:13:15', NULL, 72),
(143, 'へろ', 'あや', '2024-12-15 23:01:51', NULL, 73),
(144, 'yada', 'ちょこぱん', '2024-12-15 23:10:59', 5, NULL),
(145, 'はい', '原口', '2024-12-15 23:30:18', 19, NULL),
(146, 'いやだ。', '原口', '2024-12-15 23:30:27', NULL, 74),
(147, 'き', '佐々木', '2024-12-16 03:27:33', NULL, 75);

-- --------------------------------------------------------

--
-- テーブルの構造 `wearingcraft`
--

CREATE TABLE `wearingcraft` (
  `id` int(11) NOT NULL,
  `acName` varchar(16) NOT NULL,
  `crName` varchar(16) NOT NULL,
  `rimitDay` int(5) DEFAULT NULL,
...
--
-- テーブルのデータのダンプ `wearingcraft`
--

INSERT INTO `wearingcraft` (`id`, `acName`, `crName`, `rimitDay`, `timeStamp`, `destiny`) VALUES
(1, 'natsumi', '自爆装置(1w)', NULL, '2024-12-16 04:28:37', -1),
(2, 'ひじり', '自爆装置(1w)', NULL, '2024-12-16 04:31:33', -1);
...
--
-- テーブルのインデックス `hascraft`
--
ALTER TABLE `hascraft`
  ADD PRIMARY KEY (`id`);
...
--
-- テーブルのインデックス `pl_upgrade`
--
ALTER TABLE `pl_upgrade`
  ADD PRIMARY KEY (`id`);
...
--
-- テーブルのインデックス `wearingcraft`
--
ALTER TABLE `wearingcraft`
  ADD PRIMARY KEY (`id`);
...
--
-- テーブルの AUTO_INCREMENT `pl_upgrade`
--
ALTER TABLE `pl_upgrade`
...
--
-- テーブルの AUTO_INCREMENT `wearingcraft`
--
ALTER TABLE `wearingcraft`
